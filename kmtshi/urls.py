...
urlpatterns = [url(r'^$', views.index, name='index'),
               ...
               url(r'^(?P<field>[A-Z0-9-]+)/candidates_main/$', views.candidates_field_main, name='candidates_field_main'),
               ...
               url(r'^(?P<field>[A-Z0-9-]+)/candidates_all/$', views.candidates_field_all, name='candidates_field_all'),
               url(r'^(?P<field>[A-Z0-9-]+)/candidates_form_all/$', views.candidates_field_form_all,name='candidates_field_form_all'),
               url(r'^(?P<field>[A-Z0-9-]+)/candidates_form_var/(?P<flag>[A-Z]+)/$', views.candidates_field_form_var, name='candidates_field_form_var'),
               url(r'^(?P<field>[A-Z0-9-]+)/candidates_simbad/$', views.candidates_field_simbad, name='candidates_field_simbad'),
               url(r'^(?P<field>[A-Z0-9-]+)/candidates_form_simbad/$', views.candidates_field_form_simbad, name='candidates_field_form_simbad'),
               url(r'^(?P<field>[A-Z0-9-]+)/candidates_ned/$', views.candidates_field_ned, name='candidates_field_ned'),
               url(r'^(?P<field>[A-Z0-9-]+)/candidates_form_ned/$', views.candidates_field_form_ned, name='candidates_field_form_ned'),
