...
urlpatterns = [url(r'^$', views.index, name='index'),
               ...
               url(r'^(?P<field>[A-Z0-9-]+)/candidates_known/$', views.candidates_field_known, name='candidates_field_known'),
               url(r'^(?P<field>[A-Z0-9-]+)/candidates_form_known/$', views.candidates_field_form_known, name='candidates_field_form_known'),
