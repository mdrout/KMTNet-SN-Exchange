...
def cphotom_list(candidate_ids,all_dates=False,initial_pass=False):
    ...
    if initial_pass:
        print('Field = ',flds[0],'Quad = ',quads[0],'Objects = ',len(candidate_ids),' initial pass for new candidates')
    else:
        print('Field = ', flds[0], 'Quad = ', quads[0],'Objects = ',len(candidate_ids),' update for existing candidates')
